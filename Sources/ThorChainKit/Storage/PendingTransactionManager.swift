...
/// Projects the local send journal only. Historical Cosmos transactions belong
/// to `TransactionManager`, matching the TronKit ownership boundary.
final class PendingTransactionManager: @unchecked Sendable {
