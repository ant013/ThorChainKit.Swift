...
- Final HEAD: d29e21591b73712903756a936559fa736ebbfc75
...
- THR139-THOR-GATES verification/passed: Exact head d29e215: S1-02 PASS; S1-03 5/5, 9/9, 56/56; S1-04 83/83 with public, script, and build-only policy gates.
- THR139-UW-LOCAL acceptance/passed: UW HEAD 8a63bfda remained local and uncommitted; pinned iOS 26.2 iPhone 17 Pro manager suite passed 12/12 and Development build succeeded.
- THR139-LIVE-THREE-FAMILY acceptance/passed: All three exact-head mainnet smokes passed with thorchain-1, height agreement, RUNE 1079580 equality, and audited absent-account empty state.
- THR139-DIFF-PROVENANCE verification/passed: Manifest delta contains three approved pool/test changes and removal of two rejected MultiSwap changes; 34 in-scope files match reviewed correction bytes; user-owned MultiSwap test edit preserved.
- THR139-RORCUAL-INTERMITTENCY residual_risk/accepted_risk: Rorcual produced three earlier network timeouts, then passed unchanged after endpoint recovery; multi-family failover and deterministic endpoint matrix remain the production mitigation.
